...
- **GATE**: Nothing builds until Howard rules on the matrix (Q1–8) + delta report (Q9–17) in one sitting. Queued behind it (authorized): MODEL LEDGER panel, Part-2 Add-Dormer drag-to-adjust, money-surfaces map.
