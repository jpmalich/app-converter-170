...
SECTION_LAYOUT = [
    ...
    ("Vinyl Soffit with Siding", False, [
        # Iter 34: Charter Oak soffit/fascia + 3/4" Soffit J-Channel now split
        # into Standard-color and Architectural-color variants per Howard's
        # updated price sheet. Greenbriar / T2 remain single-variant.
...
ITEM_META = {
    ...
    'Conquest Standard color Clap 4.5" .040': ("SQ", 125),
    'Conquest Standard color Dutch lap 4.5" .040': ("SQ", 125),
    'Conquest Architectural color Clap 4.5" .040': ("SQ", 125),
    'Conquest Architectural color Dutch lap 4.5" .040': ("SQ", 125),
    'Coventry Standard color Clap 4" .042': ("SQ", 125),
    'Coventry Standard color Dutch lap 4" .042': ("SQ", 125),
    'Coventry Architectural color Clap 4" .042': ("SQ", 125),
    'Coventry Architectural color Dutch lap 4" .042': ("SQ", 125),
    'Coventry Standard color Clap 5" .042': ("SQ", 125),
    'Coventry Standard color Dutch lap 5" .042': ("SQ", 125),
    'Coventry Architectural color Clap 5" .042': ("SQ", 125),
    'Coventry Architectural color Dutch lap 5" .042': ("SQ", 125),
    'Odyssey Standard color Clap 4" .044': ("SQ", 125),
    'Odyssey Standard color Dutch Lap 4" .044': ("SQ", 125),
    'Odyssey Architectural color Clap 4" .044': ("SQ", 125),
    'Odyssey Architectural color Dutch Lap 4" .044': ("SQ", 125),
    'Odyssey Standard color Clap 5" .044': ("SQ", 125),
    'Odyssey Standard color Dutch Lap 5" .044': ("SQ", 125),
    'Odyssey Architectural color Clap 5" .044': ("SQ", 125),
    'Odyssey Architectural color Dutch Lap 5" .044': ("SQ", 125),
    'Charter Oak Standard color Clap 4.5" .046': ("SQ", 125),
    'Charter Oak Standard color Dutch Lap 4.5" .046': ("SQ", 125),
    'Charter Oak Architectural color Clap 4.5" .046': ("SQ", 125),
    'Charter Oak Architectural color Dutch Lap 4.5" .046': ("SQ", 125),
    'vertical board and batten Standard color 7"': ("SQ", 125),
    'vertical board and batten Architectural color 7"': ("SQ", 125),
    'Pelican Bay Shakes 9"': ("SQ", 125),
    ...
    'Soffit & fascia up to 13" wide Charter Oak Standard color': ("LF", 2.75),
    'Soffit & fascia up to 13" wide Charter Oak Architectural color': ("LF", 2.75),
    'Soffit & fascia up to 13" wide Greenbriar': ("LF", 2.75),
    'Soffit & fascia up to 13" T2': ("LF", 2.75),
    'Soffit & fascia up to 13"-30" wide Charter Oak Standard color': ("LF", 3.5),
    'Soffit & fascia up to 13"-30" wide Charter Oak Architectural color': ("LF", 3.5),
    'Soffit & fascia up to 13"-30" wide Greenbriar': ("LF", 3.5),
    'Soffit & fascia up to 13"-30" T2': ("LF", 3.5),
    '3/4" Soffit J-Channel (Charter Oak) Standard color': ("LF", 0),
    '3/4" Soffit J-Channel (Charter Oak) Architectural color': ("LF", 0),
    '1/2" Soffit J-Channel (for T2 Soffit)': ("LF", 0),
...
TIER_PRICES = {
    "one-opp": {
        # Iter 34: explicit Standard/Architectural variants per Howard's
        # updated Excel. Clap and Dutch Lap share the same price within
        # a (profile, color) tier — Excel lists them on one row.
        'Conquest Standard color Clap 4.5" .040': 75.71,
        'Conquest Standard color Dutch lap 4.5" .040': 75.71,
        'Conquest Architectural color Clap 4.5" .040': 75.71,
        'Conquest Architectural color Dutch lap 4.5" .040': 75.71,
        'Coventry Standard color Clap 4" .042': 81.17,
        'Coventry Standard color Dutch lap 4" .042': 81.17,
        'Coventry Architectural color Clap 4" .042': 88.10,
        'Coventry Architectural color Dutch lap 4" .042': 88.10,
        'Coventry Standard color Clap 5" .042': 81.17,
        'Coventry Standard color Dutch lap 5" .042': 81.17,
        'Coventry Architectural color Clap 5" .042': 88.10,
        'Coventry Architectural color Dutch lap 5" .042': 88.10,
        'Odyssey Standard color Clap 4" .044': 100.11,
        'Odyssey Standard color Dutch Lap 4" .044': 100.11,
        'Odyssey Architectural color Clap 4" .044': 108.47,
        'Odyssey Architectural color Dutch Lap 4" .044': 108.47,
        'Odyssey Standard color Clap 5" .044': 100.11,
        'Odyssey Standard color Dutch Lap 5" .044': 100.11,
        'Odyssey Architectural color Clap 5" .044': 108.47,
        'Odyssey Architectural color Dutch Lap 5" .044': 108.47,
        'Charter Oak Standard color Clap 4.5" .046': 113.57,
        'Charter Oak Standard color Dutch Lap 4.5" .046': 113.57,
        'Charter Oak Architectural color Clap 4.5" .046': 123.40,
        'Charter Oak Architectural color Dutch Lap 4.5" .046': 123.40,
        'vertical board and batten Standard color 7"': 113.57,
        'vertical board and batten Architectural color 7"': 123.40,
        ...
        # Iter 34: accessories split into Standard/Architectural variants.
        "Outside corners Standard color": 19.69,
        "Outside corners Architectural color": 21.58,
        "Inside Corners (Siding) Standard color": 9.84,
        "Inside Corners (Siding) Architectural color": 10.97,
        '3/4" J-Channel Standard color (2 per Sq of siding)': 4.55,
        '3/4" J-Channel Architectural color (2 per Sq of siding)': 4.55,
        '1/2" J-Channel (2 per Sq of siding)': 4.55,
        "Finish Trim Standard color": 0.45,
        "Finish Trim Architectural color": 0.49,
        "Starter": 7.46,
        ...
        # Iter 34: Charter Oak soffit split into Standard/Architectural variants.
        'Soffit & fascia up to 13" wide Charter Oak Standard color': 1.40,
        'Soffit & fascia up to 13" wide Charter Oak Architectural color': 1.55,
        'Soffit & fascia up to 13" wide Greenbriar': 1.23,
        'Soffit & fascia up to 13" T2': 0.95,
        'Soffit & fascia up to 13"-30" wide Charter Oak Standard color': 2.80,
        'Soffit & fascia up to 13"-30" wide Charter Oak Architectural color': 3.10,
        'Soffit & fascia up to 13"-30" wide Greenbriar': 2.46,
        'Soffit & fascia up to 13"-30" T2': 1.90,
        '3/4" Soffit J-Channel (Charter Oak) Standard color': 0.46,
        '3/4" Soffit J-Channel (Charter Oak) Architectural color': 0.52,
        '1/2" Soffit J-Channel (for T2 Soffit)': 0.46,
    ...
    "Builder-Dealer": {
        'Conquest Standard color Clap 4.5" .040': 92.19,
        'Conquest Standard color Dutch lap 4.5" .040': 92.19,
        'Conquest Architectural color Clap 4.5" .040': 102.84,
        'Conquest Architectural color Dutch lap 4.5" .040': 102.84,
        'Coventry Standard color Clap 4" .042': 95.04,
        'Coventry Standard color Dutch lap 4" .042': 95.04,
        'Coventry Architectural color Clap 4" .042': 105.68,
        'Coventry Architectural color Dutch lap 4" .042': 105.68,
        'Coventry Standard color Clap 5" .042': 95.04,
        'Coventry Standard color Dutch lap 5" .042': 95.04,
        'Coventry Architectural color Clap 5" .042': 105.68,
        'Coventry Architectural color Dutch lap 5" .042': 105.68,
        'Odyssey Standard color Clap 4" .044': 116.22,
        'Odyssey Standard color Dutch Lap 4" .044': 116.22,
        'Odyssey Architectural color Clap 4" .044': 127.44,
        'Odyssey Architectural color Dutch Lap 4" .044': 127.44,
        'Odyssey Standard color Clap 5" .044': 116.22,
        'Odyssey Standard color Dutch Lap 5" .044': 116.22,
        'Odyssey Architectural color Clap 5" .044': 127.44,
        'Odyssey Architectural color Dutch Lap 5" .044': 127.44,
        'Charter Oak Standard color Clap 4.5" .046': 125.46,
        'Charter Oak Standard color Dutch Lap 4.5" .046': 125.46,
        'Charter Oak Architectural color Clap 4.5" .046': 141.21,
        'Charter Oak Architectural color Dutch Lap 4.5" .046': 141.21,
        'vertical board and batten Standard color 7"': 136.56,
        'vertical board and batten Architectural color 7"': 157.86,
        'Pelican Bay Shakes 9"': 419.94,
        ...
        "Outside corners Standard color": 23.66,
        "Outside corners Architectural color": 25.94,
        "Inside Corners (Siding) Standard color": 11.83,
        "Inside Corners (Siding) Architectural color": 13.20,
        '3/4" J-Channel Standard color (2 per Sq of siding)': 5.23,
        '3/4" J-Channel Architectural color (2 per Sq of siding)': 6.03,
        '1/2" J-Channel (2 per Sq of siding)': 5.23,
        "Finish Trim Standard color": 5.95,
        "Finish Trim Architectural color": 6.45,
        "Starter": 7.46,
        "House Wrap": 11.55, "RainDrop": 30.73, '3/8" Fan Fold': 11.06,
        '2" Nails 30 lbs (1 per 15 Sq)': 81.63, "Caulking (per color)": 8.23,
        "J-blocks, Dryer vents": 13.49,
        ...
        "Tear-Off": 0, "Wood shake tear off (requires a dumpster)": 0,
        "Clean up / haul away job debris": 0, "Dumpster": 0,
        'Soffit & fascia up to 13" wide Charter Oak Standard color': 1.82,
        'Soffit & fascia up to 13" wide Charter Oak Architectural color': 2.02,
        'Soffit & fascia up to 13" wide Greenbriar': 1.63,
        'Soffit & fascia up to 13" T2': 1.38,
        'Soffit & fascia up to 13"-30" wide Charter Oak Standard color': 3.64,
        'Soffit & fascia up to 13"-30" wide Charter Oak Architectural color': 4.04,
        'Soffit & fascia up to 13"-30" wide Greenbriar': 3.26,
        'Soffit & fascia up to 13"-30" T2': 2.76,
        '3/4" Soffit J-Channel (Charter Oak) Standard color': 0.52,
        '3/4" Soffit J-Channel (Charter Oak) Architectural color': 0.60,
        '1/2" Soffit J-Channel (for T2 Soffit)': 0.53,
    ...
    "Contractor": {
        'Conquest Standard color Clap 4.5" .040': 97.04,
        'Conquest Standard color Dutch lap 4.5" .040': 97.04,
        'Conquest Architectural color Clap 4.5" .040': 108.24,
        'Conquest Architectural color Dutch lap 4.5" .040': 108.24,
        'Coventry Standard color Clap 4" .042': 100.03,
        'Coventry Standard color Dutch lap 4" .042': 100.03,
        'Coventry Architectural color Clap 4" .042': 111.24,
        'Coventry Architectural color Dutch lap 4" .042': 111.24,
        'Coventry Standard color Clap 5" .042': 100.03,
        'Coventry Standard color Dutch lap 5" .042': 100.03,
        'Coventry Architectural color Clap 5" .042': 111.24,
        'Coventry Architectural color Dutch lap 5" .042': 111.24,
        'Odyssey Standard color Clap 4" .044': 116.22,
        'Odyssey Standard color Dutch Lap 4" .044': 116.22,
        'Odyssey Architectural color Clap 4" .044': 127.44,
        'Odyssey Architectural color Dutch Lap 4" .044': 127.44,
        ...
        'Odyssey Architectural color Clap 5" .044': 127.44,
        'Odyssey Architectural color Dutch Lap 5" .044': 127.44,
        'Charter Oak Standard color Clap 4.5" .046': 136.22,
        'Charter Oak Standard color Dutch Lap 4.5" .046': 136.22,
        'Charter Oak Architectural color Clap 4.5" .046': 151.97,
        'Charter Oak Architectural color Dutch Lap 4.5" .046': 151.97,
        'vertical board and batten Standard color 7"': 143.74,
        'vertical board and batten Architectural color 7"': 166.16,
        'Pelican Bay Shakes 9"': 419.94,
        'Ascend Composite Lap Siding 7"': 332.6, 'Ascend Composite B&B 12" (add 30% Waste)': 408.66,
        'Ascend 3.5" Outside Corner  - MATTE': 40.42, 'Ascend 5.5" Outside Corner  - MATTE': 59.36,
        "Inside Corners": 11.83, "Ascend - 5.5\" Trim  (16' length)": 71.66,
        ...
        ".019 Coil (1 per 5 Sq Siding)": 161.33, "PVC Trim Coil (1 per 5 Sq Siding)": 167.08,
        "Performance G8 Trim Coil (1 per 5 Sq Siding)": 170.53,
        "Outside corners Standard color": 25.81,
        "Outside corners Architectural color": 28.29,
        "Inside Corners (Siding) Standard color": 12.90,
        "Inside Corners (Siding) Architectural color": 14.39,
        '3/4" J-Channel Standard color (2 per Sq of siding)': 5.23,
        '3/4" J-Channel Architectural color (2 per Sq of siding)': 6.03,
        '1/2" J-Channel (2 per Sq of siding)': 5.23,
        "Finish Trim Standard color": 5.95,
        ...
        "Tear-Off": 0, "Wood shake tear off (requires a dumpster)": 0,
        "Clean up / haul away job debris": 0, "Dumpster": 0,
        'Soffit & fascia up to 13" wide Charter Oak Standard color': 1.91,
        'Soffit & fascia up to 13" wide Charter Oak Architectural color': 2.12,
        'Soffit & fascia up to 13" wide Greenbriar': 1.71,
        'Soffit & fascia up to 13" T2': 1.36,
        'Soffit & fascia up to 13"-30" wide Charter Oak Standard color': 3.82,
        'Soffit & fascia up to 13"-30" wide Charter Oak Architectural color': 4.24,
        'Soffit & fascia up to 13"-30" wide Greenbriar': 3.24,
        'Soffit & fascia up to 13"-30" T2': 2.72,
        '3/4" Soffit J-Channel (Charter Oak) Standard color': 0.52,
        '3/4" Soffit J-Channel (Charter Oak) Architectural color': 0.60,
        '1/2" Soffit J-Channel (for T2 Soffit)': 0.52,
        'Fascia/rake or frieze up to 8" coverage': 2.94, "Cap porch band": 2.94,
        ".019 Coil (1 per 50' fascia)": 161.33,
        "PVC Trim Coil (1 per 50' fascia)": 167.08,
        "Performance G8 Trim Coil (1 per 50' fascia)": 170.53,
        "With or without siding Charter Oak": 1.91, "Wrap porch beam": 3.22,
        'Gutter 6"': 3.25, 'Downspout 6"': 2.8, "elbow": 2.69, "Mitre": 13.75,
        "Gutter Guard (USA Shurflo)": 2.25,
        "R&R gutter": 0, "R&R downspout": 0,
        "Cap window": 0, "Cap windows with wide crown": 65, "Capping general": 0,
    ...
    "whole-sale": {
        'Conquest Standard color Clap 4.5" .040': 102.15,
        'Conquest Standard color Dutch lap 4.5" .040': 102.15,
        'Conquest Architectural color Clap 4.5" .040': 113.94,
        'Conquest Architectural color Dutch lap 4.5" .040': 113.94,
        'Coventry Standard color Clap 4" .042': 105.30,
        'Coventry Standard color Dutch lap 4" .042': 105.30,
        'Coventry Architectural color Clap 4" .042': 117.09,
        'Coventry Architectural color Dutch lap 4" .042': 117.09,
        'Coventry Standard color Clap 5" .042': 105.30,
        'Coventry Standard color Dutch lap 5" .042': 105.30,
        'Coventry Architectural color Clap 5" .042': 117.09,
        'Coventry Architectural color Dutch lap 5" .042': 117.09,
        'Odyssey Standard color Clap 4" .044': 122.34,
        'Odyssey Standard color Dutch Lap 4" .044': 122.34,
        'Odyssey Architectural color Clap 4" .044': 134.14,
        'Odyssey Architectural color Dutch Lap 4" .044': 134.14,
        'Odyssey Standard color Clap 5" .044': 122.34,
        'Odyssey Standard color Dutch Lap 5" .044': 122.34,
        'Odyssey Architectural color Clap 5" .044': 134.14,
        'Odyssey Architectural color Dutch Lap 5" .044': 134.14,
        'Charter Oak Standard color Clap 4.5" .046': 151.31,
        'Charter Oak Standard color Dutch Lap 4.5" .046': 151.31,
        'Charter Oak Architectural color Clap 4.5" .046': 174.90,
        'Charter Oak Architectural color Dutch Lap 4.5" .046': 174.90,
        'vertical board and batten Standard color 7"': 151.31,
        'vertical board and batten Architectural color 7"': 174.90,
        'Pelican Bay Shakes 9"': 419.94,
        'Ascend Composite Lap Siding 7"': 332.6, 'Ascend Composite B&B 12" (add 30% Waste)': 408.66,
        'Ascend 3.5" Outside Corner  - MATTE': 40.42, 'Ascend 5.5" Outside Corner  - MATTE': 59.36,
        "Inside Corners": 11.83, "Ascend - 5.5\" Trim  (16' length)": 71.66,
        ...
        ".019 Coil (1 per 5 Sq Siding)": 161.33, "PVC Trim Coil (1 per 5 Sq Siding)": 167.08,
        "Performance G8 Trim Coil (1 per 5 Sq Siding)": 170.53,
        "Outside corners Standard color": 31.54,
        "Outside corners Architectural color": 34.58,
        "Inside Corners (Siding) Standard color": 15.77,
        "Inside Corners (Siding) Architectural color": 17.59,
        '3/4" J-Channel Standard color (2 per Sq of siding)': 7.28,
        '3/4" J-Channel Architectural color (2 per Sq of siding)': 8.49,
        '1/2" J-Channel (2 per Sq of siding)': 7.28,
        "Finish Trim Standard color": 7.28,
        "Finish Trim Architectural color": 7.88,
        "Starter": 7.46,
        "House Wrap": 11.55, "RainDrop": 30.73, '3/8" Fan Fold': 11.06,
        '2" Nails 30 lbs (1 per 15 Sq)': 81.63, "Caulking (per color)": 8.23,
        "J-blocks, Dryer vents": 13.49,
        ...
        "Tear-Off": 0, "Wood shake tear off (requires a dumpster)": 0,
        "Clean up / haul away job debris": 0, "Dumpster": 0,
        'Soffit & fascia up to 13" wide Charter Oak Standard color': 2.02,
        'Soffit & fascia up to 13" wide Charter Oak Architectural color': 2.24,
        'Soffit & fascia up to 13" wide Greenbriar': 1.80,
        'Soffit & fascia up to 13" T2': 1.36,
        'Soffit & fascia up to 13"-30" wide Charter Oak Standard color': 3.64,
        'Soffit & fascia up to 13"-30" wide Charter Oak Architectural color': 4.48,
        'Soffit & fascia up to 13"-30" wide Greenbriar': 3.24,
        'Soffit & fascia up to 13"-30" T2': 2.72,
        '3/4" Soffit J-Channel (Charter Oak) Standard color': 0.73,
        '3/4" Soffit J-Channel (Charter Oak) Architectural color': 0.85,
        '1/2" Soffit J-Channel (for T2 Soffit)': 0.72,
        'Fascia/rake or frieze up to 8" coverage': 0, "Cap porch band": 0,
        ".019 Coil (1 per 50' fascia)": 161.33,
        "PVC Trim Coil (1 per 50' fascia)": 167.08,
        "Performance G8 Trim Coil (1 per 50' fascia)": 170.53,
        "With or without siding Charter Oak": 2.02, "Wrap porch beam": 0,
        'Gutter 6"': 3.25, 'Downspout 6"': 2.8, "elbow": 2.69, "Mitre": 13.75,
        "Gutter Guard (USA Shurflo)": 2.25,
        "R&R gutter": 0, "R&R downspout": 0,
        "Cap window": 0, "Cap windows with wide crown": 65, "Capping general": 0,
...
ITEM_AMI = {
    ...
    'Soffit & fascia up to 13" wide Charter Oak Standard color': "105020",
    'Soffit & fascia up to 13" wide Charter Oak Architectural color': "105020",
    'Soffit & fascia up to 13" wide Greenbriar': "106022",
    'Soffit & fascia up to 13" T2': "105007",
    'Soffit & fascia up to 13"-30" wide Charter Oak Standard color': "105020",
    'Soffit & fascia up to 13"-30" wide Charter Oak Architectural color': "105020",
