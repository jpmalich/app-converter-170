...
SECTION_LAYOUT = [
    ...
    ("Ascend Cladding/Accessories", True, [
        # Iter 79 (Feb 2026): "Inside Corners" dropped per supplier — Ascend
        # has no true inside-corner SKU; removed from XLSX master sheet.
    ...
    ("Siding Accessories", False, [
        ...
        '2" Nails 30 lbs', "Caulking (per color)",
    ...
    ("Vinyl Soffit with Siding", False, [
        ...
        # Iter 79 (Feb 2026): supplier renamed soffit + J-Channel SKUs to
        # the "Soffit & fascia ..." prefix to unify with the rest of the
        # vinyl accessory naming.
        ...
        '1/2" J-Channel White',
        'Fascia/rake or frieze', "Cap porch band",
        ".019 Coil",
        "PVC Trim Coil",
        "Performance G8 Trim Coil",
    ]),
    ("Porch Ceiling", False, [
        ...
        # previously "With or without siding Charter Oak" sold per sqft at
        # $1.40–$2.02, now sold per piece of "Charter Oak Soffit White" at
        # $14.00–$20.20 (matches the Vinyl Soffit section's Charter Oak
        # Standard Color piece price). 1 piece covers ~10 sqft (10" exposure
        # × 12' panel) so the auto-recalc hook divides porch sqft by 10.
        "Charter Oak Soffit White", "Wrap porch beam",
    ]),
...
ITEM_META = {
    ...
    '3/4" J-Channel Standard color': ("PCS", 0),
    '3/4" J-Channel Architectural color': ("PCS", 0),
    '1/2" J-Channel': ("PCS", 0),
    ...
    'Soffit & fascia Charter Oak Standard Color': ("PCS", 0),
    'Soffit & fascia Charter Oak Architectural color': ("PCS", 0),
    'Soffit & fascia Greenbriar': ("PCS", 0),
    'Soffit & fascia 2T': ("PCS", 0),
...
ZERO_PRICED = {
    ...
    'Cap windows with wide crown',
    'Capping general',
    'Clean up / haul away job debris',
    'Dormer upcharge',
    'Dumpster',
    'Fascia Return',
    'Fascia/rake or frieze',
    'Flashing',
    'R&R Gable louvers',
    'R&R Utilities',
    'R&R downspout',
...
PER_TIER_PRICES = {
    ...
    '3/4" J-Channel Architectural color': {"whole-sale": 8.49, "Contractor": 6.03, "Builder-Dealer": 6.03, "one-opp": 4.55},
    '3/4" J-Channel Standard color': {"whole-sale": 7.28, "Contractor": 5.23, "Builder-Dealer": 5.23, "one-opp": 4.55},
    ...
    'Ascend - 5.5" Trim  (16\' length)': {"whole-sale": 71.66, "Contractor": 71.66, "Builder-Dealer": 71.66, "one-opp": 71.66},
    'Ascend Composite B&B 12"': {"whole-sale": 408.66, "Contractor": 408.66, "Builder-Dealer": 408.66, "one-opp": 366.96},
    'Ascend Composite Lap Siding 7"': {"whole-sale": 332.6, "Contractor": 332.6, "Builder-Dealer": 332.6, "one-opp": 309.64},
    'Cap porch band': {"whole-sale": 0, "Contractor": 0, "Builder-Dealer": 0, "one-opp": 0},
    ...
    'Soffit & fascia Charter Oak Standard Color': {"whole-sale": 20.2, "Contractor": 19.2, "Builder-Dealer": 18.2, "one-opp": 14.0},
    'Soffit & fascia Greenbriar': {"whole-sale": 18.02, "Contractor": 17.1, "Builder-Dealer": 16.3, "one-opp": 12.3},
    'Charter Oak Soffit White': {"whole-sale": 20.2, "Contractor": 19.2, "Builder-Dealer": 18.2, "one-opp": 14.0},
    'Wrap porch beam': {"whole-sale": 0, "Contractor": 0, "Builder-Dealer": 0, "one-opp": 0},
...
LP_COIL_PRICES_BY_TIER = {
    tier: {
        ...
        'PVC Trim Coil':          PER_TIER_PRICES['PVC Trim Coil'][tier],
        'Performance G8 Trim Coil': PER_TIER_PRICES['Performance G8 Trim Coil'][tier],
    }
...
ITEM_AMI = {
    ...
    'Ascend Composite B&B 12"': "018021",
    ...
    '3/4" J-Channel Standard color': "105118",
    '3/4" J-Channel Architectural color': "105118",
    '1/2" J-Channel': "105114",
    ...
    'Soffit & fascia Charter Oak Standard Color': "105020",
