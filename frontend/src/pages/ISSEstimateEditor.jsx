      ...
      <div className="sell-bar" data-testid="iss-sticky-bar">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center gap-3 sm:gap-6">
          ...
          <div className="flex items-stretch gap-2 sm:gap-3 flex-wrap">
            ...
            >
              <div className="text-[10px] uppercase tracking-[0.18em] font-bold text-[var(--brand-text)]">
                ISS Quote
              </div>
              <div
                className="font-mono-num text-base sm:text-xl font-bold text-[var(--brand-text)]"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <section className="card p-6 mt-4" data-testid="iss-totals-summary">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
            ...
            <Stat
              label={`Material incl. ${est.waste_pct || 0}% cut waste`}
