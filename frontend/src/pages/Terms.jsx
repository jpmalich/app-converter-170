...
export default function Terms() {
  return (
    <div className="min-h-screen bg-[#F4F4F5] flex flex-col" data-testid="terms-page">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="prose prose-sm text-[#52525B] space-y-6 leading-relaxed">
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">2. Account &amp; Access</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">3. Permitted Use</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">4. Pricing &amp; Catalog</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">5. Your Content</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">6. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">7. Disclaimer &amp; Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">8. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-xl text-[#09090B] mb-2">9. Changes</h2>
            <p>
