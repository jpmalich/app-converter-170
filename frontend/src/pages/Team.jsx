...
export default function Team() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-testid="team-page">
      ...
      {/* Iter 79j.46 — Inline theme picker. Contractor-only styling —
          the blurb below explicitly reminds the owner it does not
          leak into customer-facing surfaces. */}
        ...
        <div className="flex items-center gap-5">
          <div className="w-24 h-24 border-2 border-[var(--border)] bg-[var(--bar-bg)] flex items-center justify-center overflow-hidden">
            {logoFullUrl ? (
              ...
              <div className="font-heading text-[var(--brand-text)] text-4xl" data-testid="logo-placeholder">
